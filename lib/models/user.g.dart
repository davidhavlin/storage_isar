...
int _userEstimateSize(
  ...
  bytesCount += 3 +
      CompanySchema.estimateSize(
          object.company, allOffsets[Company]!, allOffsets);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    id: id,
    lastFetched: reader.readDateTime(offsets[3]),
    name: reader.readString(offsets[4]),
    phone: reader.readString(offsets[5]),
    username: reader.readString(offsets[6]),
    website: reader.readString(offsets[7]),
  );
  return object;
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastFetchedEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastFetchedGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastFetchedLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastFetchedBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByLastFetched() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastFetched', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByLastFetchedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByLastFetched() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastFetched', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByLastFetchedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastFetched', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByLastFetched() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime, QQueryOperations> lastFetchedProperty() {
    return QueryBuilder.apply(this, (query) {
